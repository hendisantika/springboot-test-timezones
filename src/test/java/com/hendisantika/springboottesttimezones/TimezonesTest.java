...
public class TimezonesTest {
    ...
    @Test
    public void testTimezones1() {

        Calendar utcCalendar = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
        utcCalendar.set(2019, Calendar.AUGUST, 4, 11, 0, 0);
        utcCalendar.clear(Calendar.MILLISECOND);

        Calendar gmt1Calendar = Calendar.getInstance();
        gmt1Calendar.set(2019, Calendar.AUGUST, 4, 11, 0, 0);
        gmt1Calendar.clear(Calendar.MILLISECOND);

        logCalendar("Written GMT+7 Cal", gmt1Calendar);
        ...
        logCalendar("Read GMT+7 Cal", gmt1Calendar2);
        logCalendar("Read UTC Cal  ", utcCalendar2);

        Assertions.assertThat(gmt1Calendar2).as("Check GMT+7 Calendar").isEqualTo(gmt1Calendar);
